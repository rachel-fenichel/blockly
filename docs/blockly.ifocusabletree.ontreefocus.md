...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [IFocusableTree](./blockly.ifocusabletree.md) &gt; [onTreeFocus](./blockly.ifocusabletree.ontreefocus.md)
...
|  --- | --- | --- |
|  node | [IFocusableNode](./blockly.ifocusablenode.md) | The node receiving active focus. |
|  previousTree | [IFocusableTree](./blockly.ifocusabletree.md) \| null | The previous tree that held active focus, or null if none. |
