...
|  [selectItemByPosition(position)](./blockly.itoolbox_interface.selectitembyposition_1_methodsignature.md) | Selects the toolbox item by it's position in the list of toolbox items. |
