...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [Connection](./blockly.connection.md) &gt; [reconnect](./blockly.connection.reconnect.md)
...
|  --- | --- | --- |
|  block | [Block](./blockly.block.md) | The block to connect this connection to. |
