...
|  --- | --- | --- |
|  keyCode | string \| number \| [KeyCodes](./blockly.utils.keycodes.md) | The key code for the keyboard shortcut. If registering a key code with a modifier (ex: ctrl+c) use ShortcutRegistry.registry.createSerializedKey; |
