...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [SeparatorFlyoutInflater](./blockly.separatorflyoutinflater.md) &gt; [load](./blockly.separatorflyoutinflater.load.md)
...
|  flyout | [IFlyout](./blockly.iflyout.md) | The flyout to create the separator for. |
