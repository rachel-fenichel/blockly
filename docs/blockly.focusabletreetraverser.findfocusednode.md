...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [FocusableTreeTraverser](./blockly.focusabletreetraverser.md) &gt; [findFocusedNode](./blockly.focusabletreetraverser.findfocusednode.md)
...
|  --- | --- | --- |
|  tree | [IFocusableTree](./blockly.ifocusabletree.md) | The IFocusableTree in which to search for a focused node. |
